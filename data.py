...
matches["date"] = pd.to_datetime(matches["date"]) #allows ml to work with date data
...
matches_rolling = matches.groupby("team").apply(lambda x: rolling_averages(x, cols, new_cols)) #apply rolling_averages func to each team
